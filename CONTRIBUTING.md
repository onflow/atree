# Contributing to Atree

The following is a set of guidelines for contributing to Atree.
...
- **What is the version of the Atree you're using**?
...
- **Explain why this enhancement would be useful** to Atree users.

### Your First Code Contribution

Unsure where to begin contributing to Atree?
You can start by looking through these "Good first issue" and "Help wanted" issues:

- [Good first issues](https://github.com/onflow/atree/labels/good%20first%20issue):
  issues which should only require a few lines of code, and a test or two.
- [Help wanted issues](https://github.com/onflow/atree/labels/help%20wanted):
...
- Engage the community in working toward the best possible Atree UX
- Enable a sustainable system for the Atree's maintainers to review contributions
...
Thank you for your interest in contributing to Atree!

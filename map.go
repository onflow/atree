...
type element interface {
	...
	Get(storage SlabStorage, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue) (MapValue, error)

	// Set returns updated element, which may be a different type of element because of hash collision.
	Set(storage SlabStorage, address Address, b DigesterBuilder, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue, value MapValue) (newElem element, existingValue MapValue, err error)

	// Remove returns matched key, value, and updated element.
	// Updated element may be nil, modified, or a different type of element.
	Remove(storage SlabStorage, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue) (MapKey, MapValue, element, error)
...
type elements interface {
	...
	Get(storage SlabStorage, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue) (MapValue, error)
	Set(storage SlabStorage, address Address, b DigesterBuilder, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue, value MapValue) (existingValue MapValue, err error)
	Remove(storage SlabStorage, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue) (MapKey, MapValue, error)
...
type MapSlab interface {
	...
	Get(storage SlabStorage, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue) (MapValue, error)
	Set(storage SlabStorage, b DigesterBuilder, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue, value MapValue) (existingValue MapValue, err error)
	Remove(storage SlabStorage, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue) (MapKey, MapValue, error)
...
func (e *singleElement) Get(storage SlabStorage, _ Digester, _ int, _ Digest, comparator Comparator, key ComparableValue) (MapValue, error) {
...
func (e *singleElement) Set(storage SlabStorage, address Address, b DigesterBuilder, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue, value MapValue) (element, MapValue, error) {
	...
	if !ok {
		return nil, nil, NewInterfaceNotImplementedError("ComparableValue")
	}
	...
	newElem, _, err = newElem.Set(storage, address, b, existingKeyDigest, level, hkey, comparator, kv, e.value)
	if err != nil {
		return nil, nil, err
	}

	newElem, _, err = newElem.Set(storage, address, b, digester, level, hkey, comparator, key, value)
	if err != nil {
		return nil, nil, err
	}

	return newElem, nil, nil
}

// Remove returns key, value, and nil element if key matches, otherwise returns error.
func (e *singleElement) Remove(storage SlabStorage, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue) (MapKey, MapValue, element, error) {
...
func (e *inlineCollisionGroup) Get(storage SlabStorage, digester Digester, level int, _ Digest, comparator Comparator, key ComparableValue) (MapValue, error) {
...
func (e *inlineCollisionGroup) Set(storage SlabStorage, address Address, b DigesterBuilder, digester Digester, level int, _ Digest, comparator Comparator, key ComparableValue, value MapValue) (element, MapValue, error) {
...
func (e *inlineCollisionGroup) Remove(storage SlabStorage, digester Digester, level int, _ Digest, comparator Comparator, key ComparableValue) (MapKey, MapValue, element, error) {
...
func (e *externalCollisionGroup) Get(storage SlabStorage, digester Digester, level int, _ Digest, comparator Comparator, key ComparableValue) (MapValue, error) {
...
func (e *externalCollisionGroup) Set(storage SlabStorage, address Address, b DigesterBuilder, digester Digester, level int, _ Digest, comparator Comparator, key ComparableValue, value MapValue) (element, MapValue, error) {
	slab, err := getMapSlab(storage, e.id)
	if err != nil {
		return nil, nil, err
	}
...
func (e *externalCollisionGroup) Remove(storage SlabStorage, digester Digester, level int, _ Digest, comparator Comparator, key ComparableValue) (MapKey, MapValue, element, error) {
...
func (e *hkeyElements) Get(storage SlabStorage, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue) (MapValue, error) {
...
func (e *hkeyElements) Set(storage SlabStorage, address Address, b DigesterBuilder, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue, value MapValue) (MapValue, error) {
...
func (e *hkeyElements) Remove(storage SlabStorage, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue) (MapKey, MapValue, error) {
...
func (e *singleElements) Get(storage SlabStorage, digester Digester, level int, _ Digest, comparator Comparator, key ComparableValue) (MapValue, error) {
...
func (e *singleElements) Set(storage SlabStorage, address Address, b DigesterBuilder, digester Digester, level int, _ Digest, comparator Comparator, key ComparableValue, value MapValue) (MapValue, error) {
...
func (e *singleElements) Remove(storage SlabStorage, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue) (MapKey, MapValue, error) {
...
func (m *MapDataSlab) Set(storage SlabStorage, b DigesterBuilder, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue, value MapValue) (MapValue, error) {
...
func (m *MapDataSlab) Remove(storage SlabStorage, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue) (MapKey, MapValue, error) {
...
func (m *MapMetaDataSlab) Get(storage SlabStorage, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue) (MapValue, error) {
...
func (m *MapMetaDataSlab) Set(storage SlabStorage, b DigesterBuilder, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue, value MapValue) (MapValue, error) {
...
func (m *MapMetaDataSlab) Remove(storage SlabStorage, digester Digester, level int, hkey Digest, comparator Comparator, key ComparableValue) (MapKey, MapValue, error) {
...
func (m *OrderedMap) Has(comparator Comparator, key ComparableValue) (bool, error) {
...
func (m *OrderedMap) Get(comparator Comparator, key ComparableValue) (Storable, error) {
...
func (m *OrderedMap) Set(comparator Comparator, key ComparableValue, value Value) (Storable, error) {
	...
	existingValue, err := m.root.Set(m.Storage, m.digesterBuilder, keyDigest, level, hkey, comparator, key, valueStorable)
	if err != nil {
		return nil, err
	}
...
func (m *OrderedMap) Remove(comparator Comparator, key ComparableValue) (Storable, Storable, error) {

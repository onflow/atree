...
func (v Uint8Value) DeepCopy(_ SlabStorage, _ Account) (Value, error) {
	return v, nil
}
...
func (v Uint16Value) DeepCopy(_ SlabStorage, _ Account) (Value, error) {
	return v, nil
}
...
func (v Uint32Value) DeepCopy(_ SlabStorage, _ Account) (Value, error) {
	return v, nil
}
...
func (v Uint64Value) DeepCopy(_ SlabStorage, _ Account) (Value, error) {
	return v, nil
}
